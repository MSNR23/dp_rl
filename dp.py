...
max_number_of_steps = 1000 # 最大ステップ数
num_episodes = 1500
...
def q_learning(runge_kutta):
    ...
    with open(csv_file_path, 'w', newline='') as csvfile:
        ...
        # while True:
            ...
            with open(csv_file_path, 'w', newline='') as csvfile:
                csv_writer = csv.writer(csvfile)
                csv_writer.writerow(['Time', 'Theta1', 'Theta2', 'Omega1', 'Omega2', 'v2', 'action', 'Reward'])
                ...
                for i in range(max_number_of_steps):
                    ...
                    csv_writer.writerow([i * dt, q1 * 180 / np.pi, q2 * 180 / np.pi, q1_dot, q2_dot, v2, action, reward])
